    ...
    return (
        <div className="min-h-screen px-6 py-12 bg-black text-gray-200">
            <div className="max-w-3xl mx-auto font-bebas">
                ...
                <p className="mb-4">
                    Kupac ima pravo da odustane od kupovine u roku od 2 dana od prijema pošiljke, u skladu sa Zakonom o zaštiti potrošača.
                </p>

                <ul className="list-disc ml-5 space-y-2">
                    <li>Trošak povratne poštarine snosi kupac.</li>
                    <li>Po prijemu vraćenog proizvoda i provere ispravnosti, novac se vraća na račun.</li>
                </ul>
